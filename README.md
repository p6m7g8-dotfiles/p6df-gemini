...
└── share
    └── gemini
        ...
        ├── state.json
        └── tmp
            ├── 9666263b172ea8f40dc74c145a0dade50ee3cb59ed762a730b9656703f511a19
            │   └── chats
            │       └── session-2026-01-19T23-42-b658e7fc.json
            ├── bin
            │   └── rg
            └── cec50a0828a69abac9f6c74d70ee674c2c02376e2859aae99c290dac643953c0
                ├── chats
                │   ├── session-2026-01-19T22-43-7790a15c.json
                │   ├── session-2026-01-19T23-00-e74f7918.json
                │   └── session-2026-01-19T23-41-9a9f78f9.json
                └── logs.json

173 directories, 580 files
```
